...
final class StockCell : UITableViewCell {
    ...
    private lazy var symbolLabel : UILabel = createLabel(text: "YNDX", fontSize: 18, red: 26, green: 26, blue: 26)
    private lazy var companyLabel : UILabel = createLabel(text: "Yandex, LLC", fontSize: 12, red: 0, green: 0, blue: 0)
    private lazy var priceLabel : UILabel = createLabel(text: "4 764,6 ₽", fontSize: 18, red: 26, green: 26, blue: 26)
    private lazy var deltaLabel : UILabel = createLabel(text: "+55 ₽ (1,15%)", fontSize: 18, red: 36, green: 178, blue: 93)
    
    private lazy var starButton : UIButton = {
        let button = UIButton()
        button.setImage(UIImage(systemName: "star"), for: .normal)
        button.tintColor = UIColor(red: 186/255, green: 186/255, blue: 186/255, alpha: 1)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            iconView.topAnchor.constraint(equalTo: mainView.topAnchor, constant: 8),
            iconView.bottomAnchor.constraint(equalTo: mainView.bottomAnchor, constant: -8),
            ...
            starButton.topAnchor.constraint(equalTo: tickerView.topAnchor, constant: 3),
    ...
    private func createLabel(text : String, fontSize : CGFloat, red: CGFloat, green : CGFloat, blue : CGFloat) -> UILabel {
        let label = UILabel()
        label.text = text
